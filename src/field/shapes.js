...
export const SHAPES = {
  ...
  triangle: {
    mode: 'fill',
    params: {
      sizeMin: 0.06,   // высота при нулевом покрытии, доли ячейки
      sizeMax: 1.61,   // высота при полном покрытии: больше — соседи слипаются
      base: 0.41,      // ширина основания от высоты
    },
    trace(path, ax, ay, ux, uy, len, p) {
