...
Портфолио Eldar Swartz (The Black Cat Studio). Одна страница: знак из
треугольников на холсте, блок навыков со зрачком и колода кейсов. Карта раскрывается в окно с кейсом:
первый — дизайн-система TTS, второй (брендинг) пока заглушка.

План, требования и backlog — в [`docs/`](docs/README.md).
...
- страж (`tooling/guardrail.mjs`) валит сборку на сыром `#hex` вне `:root`,
  `border-radius` не из токенов `--r-*`, движении без `prefers-reduced-motion`
